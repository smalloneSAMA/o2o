$(function() {
    ...
    $('.product-wrap').on('click','a',function(e) {
        ...
        if (target.hasClass('edit')) {
            window.location.href = '/o2o_war_exploded/shopadmin/productoperation?productId=' + e.currentTarget.dataset.id;
        }
        // 点击“上/下架”按钮
        ...
        // 点击“预览按钮”
            ...
            window.location.href = '/o2o_war_exploded/front/productdetail?productId=' + e.currentTarget.dataset.id;
        }
    });

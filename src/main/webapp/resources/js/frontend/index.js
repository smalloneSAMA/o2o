$(function() {
        ...
        if (data.success) {
            ...
            shopCategoryList.map(function (item, index) {
                categoryHtml += ''
                    ...
                    +          '<p class="shop-description">'+ item.shopCategoryDescription +'</p>'
                    +      '</div>'
    ...
    $('#login').click(function() {
        window.location.href = '/o2o_war_exploded/admin/login';
    });

    // 修改密码
    $('#change-pwd').click(function() {
        window.location.href = '/o2o_war_exploded/admin/changepwd';
    });
